...
from vad.utils import get_speech_timestamps, init_jit_model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ref", type=str, required=True, help="Path of ref audio.")
    parser.add_argument("--svc", type=str, required=True, help="Path of svc audio.")
    parser.add_argument("--out", type=str, required=True, help="Path of out audio.")
