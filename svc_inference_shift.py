...
def main(args):
    ...
    for shift in range(shift_l, shift_r + 1):
        ...
        write(
            os.path.join("./_svc_out", f"svc_out_{shift}.wav"),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--shift_l", type=int, default=0, help="Pitch shift key for [shift_l, shift_r]"
    )
    parser.add_argument(
        "--shift_r", type=int, default=0, help="Pitch shift key for [shift_l, shift_r]"
    )
